...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-offset-5 col-md-2 h3">
		<?php echo $announce['title']; ?>
		</div>
	</div>
	<div class="row">
		<div class=" col-md-2 col-md-offset-8 h4">
		<?php echo $announce['et_id']; ?>
		</div>
		<div class="col-md-2 h4">
		<?php echo $announce['datetime']; ?>
		</div>
	</div>
	<hr>
	<?php
		echo '<div class="row">';
		echo '<div class="col-md-6 col-md-offset-3">'.$announce["content"].'</div>';
		echo '</div>';
		echo '<hr>';
	?>
</div>				
