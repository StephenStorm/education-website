...
<div class="container-fluid">
	...
	while($announce=$announces->fetch_assoc()){
		echo '<div class="row">';
		echo '<div class="col-md-1 col-md-offset-3"><a href="./announce.php?et_id='.$announce["et_id"].'&title='.$announce["title"].'">'.$announce["title"].'</a></div>';
		echo '<div class="col-md-1"><a href="./edu_tea.php?et_id='.$announce["et_id"].'">'.$announce["et_id"].'</a></div>';
