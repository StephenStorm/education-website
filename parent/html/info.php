...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-md-1">
			<p>真实姓名</p>
			<p><?php echo $parent['p_name'];?></p>
		</div>
		<div class="col-md-1">
			<p>手机号</p>
			<p><?php echo $parent['tel'];?></p>
		</div>
		<div class="col-md-1">
			<p>Email</p>
	...
	<div class="row">
		<div class="col-md-1 col-md-offset-3">姓名</div>
		<div class="col-md-1">年龄</div>
		<div class="col-md-1">性别</div>
		<div class="col-md-1">课程方向</div>
		<div class="col-md-1">费用范围/￥</div>
	...
	while($child=$childs->fetch_assoc()){
		echo '<div class="row">';
		echo '<div class="col-md-1 col-md-offset-3">'.$child['s_name'].'</div>';
		$age=explode('-',$child['birth']);
		$age=intval(date('Y'))-intval($age[0]);//根据出生日期计算年龄
		echo '<div class="col-md-1">'.$age.'</div>';
		if($child['sex']==1){
			$sex='女';
		}else{
			$sex='男';
		}
		echo '<div class="col-md-1">'.$sex.'</div>';
		echo '<div class="col-md-1">'.$child['direction'].'</div>';
		echo '<div class="col-md-1">'.$child['fee_from'].'-'.$child['fee_to'].'</div>';
		$area='';
		...
		echo '<div class="col-md-2">'.$area.'</div>';
		echo '</div>';
		echo '<hr>';
	}
