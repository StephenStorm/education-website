...
<div class="container-fluid">
	...
	while($announce=$announces->fetch_assoc()){
		echo '<div class="row">';
		echo '<div class="col-md-1 col-md-offset-3"><a href="./news.php?a_id='.$announce["a_id"].'&title='.$announce["title"].'">'.$announce["title"].'</a></div>';
		echo '<div class="col-md-1">'.$announce["a_id"].'</div>';
